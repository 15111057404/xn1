...
<html>
  ...
  <body>
    ...
    <div class="banner1">
    <img src="/xiaoneinews/images/front/658X280-2xs.jpg" style="width: 719px;height: 306px;" />
    </div>
    <div  class="intro">
    ...
    <p>
    校内存知己<br/>
    <input type="image" onclick="window.open('http://localhost:8080/xiaoneinews/public/register.jsp')" src="/xiaoneinews/images/front/register.jpg" />
    </p>
    </div>
    <!-- 寻找你的朋友 -->
